        ...
        if (canvas) {
            try {
                ...
                const response = await axios.post('http://localhost:8900/calculate', {
                    ...
                    dict_of_vars: dictOfVars, // Pass current variables
                });
                ...
                if (resp.data) {
                    resp.data.forEach((data: Response) => {
                        if (data.assign === true) {
                            // Update the dictionary of variables
                    ...
                    // Get the bounding box of the drawn image on the canvas
                    const ctx = canvas.getContext('2d');
                    if (ctx) {
                        ...
                        // Set the position for displaying LaTeX
                        setLatexPosition({ x: centerX, y: centerY });
                    }
    
                    // Render the LaTeX output for each expression
                    resp.data.forEach((data: Response) => {
                        setTimeout(() => {
                            setResult({
